...
<div class="max-w-7xl mx-auto space-y-8"
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tr x-data="{ show: false }"
                    x-init="setTimeout(() => show = true, {{ (int) $index * 70 }})"
                    x-show="show"
                    ...
                    <td class="px-6 py-5">
                        <div class="flex items-center gap-3 flex-wrap">
                            <div class="p-2 rounded-lg bg-indigo-50 flex-shrink-0">
                    ...
                    <td class="px-6 py-5 text-center">
                        <span class="px-4 py-1.5 rounded-full bg-gray-100 text-gray-700
    ...
    {{-- ================= PAGINATION ================= --}}
    <div x-show="loaded" x-transition.opacity.duration.700ms>
